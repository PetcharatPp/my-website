...
const alarmAudio = "/teacherW3/public/alarm.mp3";

const eggTypes = [
  { name: "วิดพื้น", time: 60, description: "เสริมแกร่งแขน" },
  { name: "ซิดอัพ", time: 60, description: "ลดพุงงง" },
  { name: "แพลงก์", time: 30, description: "เสริมแขน+ลดพุง" },
  { name: "กระโดดตบ", time: 120, description: "วอมออกกำลังกาย" },
];
...
export default function Egg() {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center p-4">
      <div className="bg-red-300 rounded-2xl shadow-2xl p-6 md:p-10 w-full max-w-2xl">
        <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-6">
          เครื่องจับเวลาออกกำลังกาย
        </h1>
        ...
        {selectedEgg && (
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-700">
              คุณกำลังออกท่า: {selectedEgg.name}
            </h3>
